...
export class AboutComponent implements OnInit, OnDestroy {
  ...
  getUserList(){
    this.UserService.getUserList().subscribe(userList => this.Perfil = userList[0])
  }

  editUser(){
    if(this.aboutForm.valid){
      this.UserService.editUser(this.Perfil as Usuario).subscribe((user: Usuario) => {
        console.log("Usuario: "+ user.nombre + " editado!");
        document.getElementById("close_FormAbout")?.click();
      });
    }else{
  ...
  get foto(){
    return this.aboutForm.controls.foto;
  }
  get nombre(){
    return this.aboutForm.controls.nombre;
  }
  get apellido(){
    return this.aboutForm.controls.apellido;
  }
  get descripcion(){
    return this.aboutForm.controls.descripcion;
  }
